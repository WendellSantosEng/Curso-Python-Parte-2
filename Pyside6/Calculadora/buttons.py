...
class ButtonsGrid(QGridLayout):
    ...
    def _makeGrid(self):
        ...
        self.display.eqPressed.connect(self._apagar)
        self.display.delPressed.connect(self.display.backspace)
        self.display.clearPressed.connect(self._apagar)
        self.display.inputPressed.connect(self._apagar)
    ...
    def _eq(self):
        ...
        if not isValidNumber(displayText):
            self._showInfo("Você não digitou números suficientes para realizar a operação.")
            return
        ...
        try:
            if "^" in self.equation and isinstance(self._left, float):
                math.pow(self._left,self._right)
            else:
                result = eval(self.equation)
        except ZeroDivisionError:
            self._showError("Divisão por zero")
        except OverflowError:
            self._showError("A quantidade de algorismos ultrapassa o limite da calculadora")
